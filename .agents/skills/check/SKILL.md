...
# /check — Verificação Rápida de Compilação (Tessera Browser)
...
## Quando Usar
- Sempre que você fizer alterações em arquivos Kotlin (`.kt`), telas Jetpack Compose ou componentes visuais.
